...
- Lightdash reads analytics databases, plus the exact curated dependency of the certification-gated
  Trading view, and owns its application bucket and query results.
