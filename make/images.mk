...
.PHONY: images-check airflow-build arxiv-lens-build dbt-image-build \
	t0-trading-build lightdash-build images-build
...
images-build: airflow-build arxiv-lens-build dbt-image-build t0-trading-build lightdash-build ## Build all local images.
